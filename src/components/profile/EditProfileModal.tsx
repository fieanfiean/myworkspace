...
const textFields: { key: keyof Pick<Profile, 'full_name' | 'nickname' | 'headline' | 'company' | 'location' | 'email' | 'website'>; label: string; type?: string }[] = [
  { key: 'full_name', label: 'Full Name' }, { key: 'nickname', label: 'Nickname' }, { key: 'headline', label: 'Headline' }, { key: 'company', label: 'Company' }, { key: 'location', label: 'Location' }, { key: 'email', label: 'Email', type: 'email' }, { key: 'website', label: 'Website', type: 'url' },
];
