...
export function AIInsights() {
  ...
  return <section className="ai-insights-border relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-500 via-indigo-500 to-blue-500 p-px shadow-[0_0_35px_rgba(99,102,241,0.18)]">
    <div className="relative h-full rounded-[calc(1rem-1px)] bg-[#111827] p-5">
