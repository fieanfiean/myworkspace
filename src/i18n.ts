...
const resources = {
  en: { translation: {
    ...
    budget: {
      ...
      form: { title: 'Add Transaction', subtitle: 'Record income or an expense', scanReceipt: 'Scan Receipt / Slip', scanHint: 'Take a photo or choose a receipt image', scanning: 'Scanning receipt…', scanError: 'Failed to parse receipt. Please try again or fill manually.', scanRateLimit: 'Rate limit reached. Please wait a few seconds before scanning again.', scanServiceUnavailable: 'AI recognition is temporarily busy. Please wait a moment and scan again.', duplicateWarningTitle: 'Possible duplicate transaction', duplicateWarningDesc: '{{date}} · {{amount}} · {{merchant}} already looks similar. Review the editable fields before saving.', type: 'Type', amount: 'Amount', currency: 'Currency', exchangeRate: 'Exchange Rate', convertedAmount: 'Amount in MYR', description: 'Description', descriptionPlaceholder: 'e.g. Grocery run', date: 'Date', time: 'Time', category: 'Category', save: 'Save Transaction', saving: 'Saving…', validation: 'Enter a description, an amount greater than zero, and a valid exchange rate.', saveError: 'Unable to save the transaction.' },
  ...
  zh: { translation: {
    ...
    budget: {
      ...
      form: { title: '新增交易', subtitle: '记录一笔收入或支出', scanReceipt: '扫描收据 / 转账单', scanHint: '拍照或选择一张收据图片', scanning: '正在识别收据…', scanError: '收据识别失败，请重试或手动填写。', scanRateLimit: '已达到识别频率限制，请等待几秒后再扫描。', scanServiceUnavailable: 'AI 识别服务暂时繁忙，请稍候再扫描。', duplicateWarningTitle: '可能是重复交易', duplicateWarningDesc: '{{date}} · {{amount}} · {{merchant}} 与现有记录相似，请检查可编辑字段后再保存。', type: '类型', amount: '金额', currency: '币种', exchangeRate: '汇率', convertedAmount: '折算 MYR 金额', description: '描述', descriptionPlaceholder: '例如：采购日用品', date: '日期', time: '时间', category: '类别', save: '保存交易', saving: '正在保存…', validation: '请输入描述、大于零的金额及有效汇率。', saveError: '无法保存这笔交易。' },
