...
export const initialAboutMeData: AboutMeData = {
  experiences: [
    { id: 'w1', type: 'work', title: 'Senior Product Engineer', organization: 'Stripe', location: 'San Francisco, CA', startDate: '2022-01', endDate: '', details: 'Leading infrastructure for developer-facing APIs and SDK tooling.', tags: ['TypeScript', 'Go'], isCurrent: true },
    { id: 'w2', type: 'work', title: 'Software Engineer II', organization: 'Notion', location: 'Remote', startDate: '2019-06', endDate: '2021-07', details: 'Built collaborative editing and offline sync.', tags: ['React', 'Rust'] },
  ],
  educations: [
  ...
  achievements: [
    { id: 'a1', category: 'project', title: 'MIT Hackathon', year: '2023', tag: 'Hackathon', rank: '1st Place', description: '', imageUrl: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&auto=format&fit=crop&q=80' },
    { id: 'a2', category: 'award', title: 'Google Code Jam', year: '2022', tag: 'Competition', rank: 'Top 500 Global', description: '', imageUrl: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?w=600&auto=format&fit=crop&q=80' },
  ],
};
