export interface Experience { id: string; type: 'work'; title: string; organization: string; location: string; dateRange: string; details: string; tags: string[]; isCurrent?: boolean }
